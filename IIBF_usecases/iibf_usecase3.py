            ...
            for sub_file in glob.glob(file + "\\*"):  # individual candidate log file
                ...
                try:
                    ...
                    for index, item in enumerate(input_csv_data):
                        if item[4] != -1 and item[9] == 'RS' and str(item[2]) not in list(unique_questions.keys()):
                            ...
                            if index != 0:
                                ...
                                # output_row.append(input_csv_data[index-1][-1])
                                output_row.append(response_time)
                                output_row.append(response_time_mins)
                                output_row.append(response_time_secs)
                            else:
                    ...
                    for val in sub_file_output_rows:
                        response_min_list.append(val[19])
                        response_sec_list.append(val[20])

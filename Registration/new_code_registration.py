...
base_dir = "C:\\Users\\Sherinp\\Desktop\\dex\\Registration\\"
input_dir = "raw\\"
...
def findGeocode(city: str) -> list:
    city = 'India,' + city 
    cities = pd.read_csv('C:\\Users\\Sherinp\\Desktop\\dex\\Registration\\raw\\City.csv')
...
def process_file(file_name):
    ...
    new_df.rename(columns=dict,
                inplace=True)
    new_df.to_csv(base_dir + output_dir + client_id + '_registration_new.csv',index=False)

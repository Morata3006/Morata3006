...
base_dir = "/home/nsedex/QuestionPaper/"
input_dir = "raw/"
output_dir = "/home/data/question_paper_analysis/Transformed/"
...
def process_file(file_name):
    ...
    if not os.path.isfile(output_dir + client_id + "_question_paper.csv"):
        if extension == "xlsx":
        ...
        with open(output_dir + client_id + "_question_paper.csv", "w", newline=""
        ) as f:
            writer = csv.writer(f)
